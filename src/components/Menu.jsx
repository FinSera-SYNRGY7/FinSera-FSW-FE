...
const ServiceMenu = ({ label, navigation, icon }) => {
  return (
    <a style={{textDecoration: "none", color: "black"}} href={navigation} aria-label={label}>
    <div className={`${styles.containerServiceMenu} d-flex flex-column justify-content-center align-items-center`}>
        <div
